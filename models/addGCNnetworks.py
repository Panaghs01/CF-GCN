...
from models import SEIF_net_resnet,CBAM
import models
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    elif args.net_G == 'mamba' and args.dataset == 'CDDataset':
        net = SD_Mamba(in_channels_pre=6,in_channels_post=6,nclass=2)
    elif args.net_G == 'mamba' and args.dataset == 'CDDataset_s1only':
        net = SD_Mamba(in_channels_pre=2,in_channels_post=2,nclass=2)
    else:
...
class SEIFNet(Backbone):
    ...
    def __init__(self, args, input_nc, output_nc,
        ...
        self.backbone = SEIF_net_resnet.resnet18(pretrained=True)
